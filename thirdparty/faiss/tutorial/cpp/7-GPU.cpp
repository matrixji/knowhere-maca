...
int main() {
    ...
    if ((access(filename, F_OK)) == -1) {
        ...
        faiss::Index* ori_index =
                faiss::index_factory(d, index_description, faiss::METRIC_L2);
    ...
    //    &option0); delete index1; index1 = faiss::gpu::index_cpu_to_gpu(&res,
    //    1, &index_composition1, &option1); delete index1;
    ...
    /// std::ref(gpu_index_ptr1));
    //        std::thread t01(GpuLoad, &res, 0, &option0, &index_composition0,
    //        std::ref(gpu_index_ptr01));
    //
    //        t00.join();
    //
    //        GpuExecutor(gpu_index_ptr00, res, 0, &option0,
    //        &index_composition0, nq, nprobe, k, xq);
    //
    //        t01.join();
    ////        t2.join();
    //        GpuExecutor(gpu_index_ptr01, res, 0, &option0,
    //        &index_composition0, nq, nprobe, k, xq);
