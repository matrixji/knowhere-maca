...
int main() {
    ...
    auto init_gpu = [&](int device_id, faiss::gpu::GpuClonerOptions* option) {
        ...
        faiss::Index* tmp_index = faiss::gpu::index_cpu_to_gpu(
                &res, device_id, cpu_index, option);
        delete tmp_index;
    };

    auto gpu_executor = [&](int device_id,
...

        {
            ...
            if (option->allInGpu) {
                faiss::gpu::GpuIndexIVF* gpu_index_ivf =
                        dynamic_cast<faiss::gpu::GpuIndexIVF*>(
                ...
                faiss::IndexIVFScalarQuantizer* index_ivf =
                        dynamic_cast<faiss::IndexIVFScalarQuantizer*>(
                                gpu_index_ivf_ptr.get());
